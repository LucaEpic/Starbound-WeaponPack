...
ScytheSlash = WeaponAbility:new()

function ScytheSlash:init()
  self.comboStep = 1
...
function ScytheSlash:update(dt, fireMode, shiftHeld)
...
function ScytheSlash:shouldActivate()
...
function ScytheSlash:readyFlash()
  animator.setGlobalTag("bladeDirectives", self.flashDirectives)
  self.flashTimer = self.flashTime
end

function ScytheSlash:computeDamageAndCooldowns()
  local attackTimes = {}
